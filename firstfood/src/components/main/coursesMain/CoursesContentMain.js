      ...
      >
        <FsLightbox
          ...
          sources={
            ...
            `/assets/images/courses/${item.course_name=='鯖魚味噌煮'?'鯖魚味噌煮':'俄羅斯料理'}/1.jpg`,
            `/assets/images/courses/${item.course_name=='鯖魚味噌煮'?'鯖魚味噌煮':'俄羅斯料理'}/2.jpg`,
            `/assets/images/courses/${item.course_name=='鯖魚味噌煮'?'鯖魚味噌煮':'俄羅斯料理'}/3.jpg`,
            ...
            <div className="col-12 col-sm-7">
              <figure className="contentFigureSmall">
                <img
                  ...
                  className="ml-0"
                  src={`/assets/images/courses/${item.course_name=='鯖魚味噌煮'?'鯖魚味噌煮':'俄羅斯料理'}/1.jpg`}
                  alt=""
                />
                <img
                  onClick={() => openLightboxOnSlide(3)}
                  src={`/assets/images/courses/${item.course_name=='鯖魚味噌煮'?'鯖魚味噌煮':'俄羅斯料理'}/2.jpg`}
                  alt=""
                />
                <img
                  onClick={() => openLightboxOnSlide(4)}
                  src={`/assets/images/courses/${item.course_name=='鯖魚味噌煮'?'鯖魚味噌煮':'俄羅斯料理'}/3.jpg`}
                  alt=""
                />
                <img
                  onClick={() => openLightboxOnSlide(4)}
